...
BOOST_AUTO_TEST_CASE ( h2o_sto3g ) {
    ...
    BOOST_CHECK(hf::utility::are_equal_eigenvalues(ref_orbital_energies, scf.orbital_energies, 1.0e-06));
    BOOST_CHECK(hf::utility::are_equal_sets_eigenvectors(C_ref, scf.C_canonical, 1.0e-05));
}
