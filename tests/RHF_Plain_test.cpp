...
BOOST_AUTO_TEST_CASE ( constructor ) {
    ...
    ao_basis1.calculateIntegrals();  // need to calculate one of the integrals to be able to access the number of basis functions
    ...
    ao_basis2.calculateIntegrals();  // need to calculate one of the integrals to be able to access the number of basis functions
...
BOOST_AUTO_TEST_CASE ( homo ) {
    ...
    libwint::Molecule water ("../tests/ref_data/h2o_crawdad.xyz");
    libwint::AOBasis ao_basis (water, "STO-3G");
    ao_basis.calculateIntegrals();  // need to calculate one of the integrals to be able to access the number of basis functions
